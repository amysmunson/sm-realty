  ...
  return (
    <main>
      <div className="relative w-full mb-10 p-4 pt-20">
        <h1 className="heading-page">About</h1>
      </div>
      ...
      <div className="container mx-auto px-4 mb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="about-card">
            ...
            <h3 className="about-card-heading">Residential Rentals</h3>
          ...
          <div className="about-card">
            ...
            <h3 className="about-card-heading">Residential Sales</h3>
            <p className="about-card-text">
          ...
          <div className="about-card">
            ...
            <h3 className="about-card-heading">Property Management</h3>
            <p className="about-card-text">
      ...
      <div className="container mx-auto px-4 pt-10 justify-center text-center">
        <div className="mb-10">
          <h1 className="heading-page">Our Team</h1>
        </div>
